...
import { confetti } from 'dom-confetti/src/main'
...
!(function () {
  ...
  const todoApp = (rootEl, nextId, opt = {}) => {
  ...
  const nextId = incrementId(store.get('nextId', 0), (n) => store.set('nextId', n))
